...
print("=== SAFE AGENT V39 STANDALONE BUILD ===")

target = "safe_agent_v39.py"

V39_CODE = r'''#!/usr/bin/env python3
...
Path(target).write_text(V39_CODE, encoding="utf-8")
