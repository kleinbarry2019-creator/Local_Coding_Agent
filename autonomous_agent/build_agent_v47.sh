...
echo "=========================================="
echo " SAFE AGENT V47 - BOUNDED PROTOCOL"
echo "=========================================="
echo "Project: $ROOT"
...
def main():
    if len(sys.argv) < 2:
        print(
            'Usage: python3 safe_agent_v47.py "AUFGABE"'
        )
        raise SystemExit(2)
...
def test_v47_model_response_limit():
    expect_blocked(
        "Model Response Limit",
...
def test_v47_network_isolation():
    name = "v47_network_probe.py"
...
def test_v47_symlink_protection():
    target = RUNTIME / "v47_link"
...
cat > tools/test_all_v47.sh <<'BASH2'
#!/usr/bin/env bash
set -Eeuo pipefail
...
python3 -m py_compile safe_agent_v47.py

python3 tests/test_v47.py
...
echo
echo "V46 TESTS PASSED"
BASH2

chmod +x tools/test_all_v47.sh


cat > tools/test_end_to_end_v47.sh <<'BASH3'
#!/usr/bin/env bash
set -Eeuo pipefail
    ...
    "messages": [
        {
            ...
            "content": (
                'Antworte exakt mit '
                '{"action":"done","result":"OLLAMA_V47_OK"}'
            ),
        }
    ],
    "stream": False,
...
if "OLLAMA_V47_OK" not in content:
    raise SystemExit(
        "OLLAMA FAIL"
    )
PY
...
rm -f runtime/v46_agent_test.txt

python3 safe_agent_v47.py \
    "Erstelle v46_agent_test.txt mit exakt V47_AGENT_OK. Lies die Datei danach wieder ein. Prüfe den Inhalt und antworte erst dann mit done."

test -f runtime/v46_agent_test.txt

test "$(
    cat runtime/v46_agent_test.txt
)" = "V47_AGENT_OK"
...
test -f safe_agent_v47.py

echo "AGENT CODE PRESENT"

echo
echo "V46 END-TO-END TESTS PASSED"
BASH3

chmod +x tools/test_end_to_end_v47.sh


cat > BUILD_INFO_V47.txt <<EOF
SAFE AGENT V47

V47 bounded-response and filesystem enumeration limits enabled.
...
echo
echo "=== V46 END-TO-END ==="
./tools/test_end_to_end_v47.sh

echo
echo "=========================================="
echo " SAFE AGENT V47 READY"
echo "=========================================="
