...
echo "=========================================="
echo " SAFE AGENT V46 - BOUNDED PROTOCOL"
echo "=========================================="
echo "Project: $ROOT"
...
def main():
    if len(sys.argv) < 2:
        print(
            'Usage: python3 safe_agent_v46.py "AUFGABE"'
        )
        raise SystemExit(2)
...
cat > tools/test_all_v46.sh <<'BASH2'
#!/usr/bin/env bash
set -Eeuo pipefail
...
python3 -m py_compile safe_agent_v46.py

python3 tests/test_v46.py
...
chmod +x tools/test_all_v46.sh


cat > tools/test_end_to_end_v46.sh <<'BASH3'
#!/usr/bin/env bash
set -Eeuo pipefail
    ...
    "messages": [
        {
            ...
            "content": (
                'Antworte exakt mit '
                '{"action":"done","result":"OLLAMA_V46_OK"}'
            ),
        }
    ],
    "stream": False,
...
if "OLLAMA_V46_OK" not in content:
    raise SystemExit(
        "OLLAMA FAIL"
    )
PY
...
python3 safe_agent_v46.py \
    "Erstelle v46_agent_test.txt mit exakt V46_AGENT_OK. Lies die Datei danach wieder ein. Prüfe den Inhalt und antworte erst dann mit done."
...
chmod +x tools/test_end_to_end_v46.sh


cat > BUILD_INFO_V46.txt <<EOF
SAFE AGENT V46
...
echo
echo "=== V46 END-TO-END ==="
./tools/test_end_to_end_v46.sh

echo
echo "=========================================="
echo " SAFE AGENT V46 READY"
echo "=========================================="
