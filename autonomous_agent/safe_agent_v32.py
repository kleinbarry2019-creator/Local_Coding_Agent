...
def get_default_state():
    return {"version": 29, "tasks_completed": 0, "last_result": "initialized"}

def get_default_state():
    return {"version": 30, "tasks_completed": 0, "last_result": "initialized"}

def get_default_state():
    return {"version": 31, "tasks_completed": 0, "last_result": "initialized"}

def get_default_state():
    return {"version": 32, "tasks_completed": 0, "last_result": "initialized"}
