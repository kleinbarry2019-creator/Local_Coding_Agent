...
print("=== SAFE AGENT V38 VISIBILITY FIX ===")
...
# Schneidet die alte Autonomie-Logik ab, falls vorhanden
if "import urllib.request" in s:
    s = s.split("import urllib.request")[0].strip()
...
Aktion 2: Fertig
{
  ...
  "result": "Lösung"
    ...
    for step in range(max_steps):
        ...
        if not match:
            print("⚠ [FEHLER] Kein JSON in der Antwort gefunden.")
        ...
        try:
            ...
            print(f"⚠ [FEHLER] JSON Parse Fehler: {e}")
